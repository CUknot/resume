...
export const technologies = [
  ...
  {
    section: "Tools",
    details: ["Git", "GitHub", "Docker", "Apache Spark", "Airflow"],
  },
  {
    section: "AI & Data",
    details: [
...
export const workExperiences = [
  {
    ...
    details: [
      "Developed backend logic and unit tests for the DocsSearch B2C system, ensuring reliability and maintainability.",
      "Implemented real-time socket communication and created comprehensive API specifications and documentation using Swagger.",
      "Performed API testing and maintained API standards to improve system consistency and developer experience.",
      "Participated in the Bolt Hackathon, contributing to API development and documentation for a competition project.",
      "Built Airflow data pipelines for automated data processing and developed a web dashboard to analyze and visualize data in the Wongwai Project.",
      "Explored and integrated Pinecone (Vector Database) in an Agentic RAG web project, enhancing AI-powered search capabilities."
    ],
  },
];
...
export const activities = [
  {
    ...
    details: [
      "Resulted in personalized product recommendations across multiple channels with improved user experience by designing automated user promotion management and custom AI personalities to optimize retail processes and increase customer satisfaction."
    ],
  },
  {
...
export const projects = [
  ...
  {
    name: "Agentic RAG Web Project",
    stack: "Python, Gemini API, Langchain, Qdrant",
    details: "An NLP final project that implements a chatbot for an accommodation-finding web app (similar to Agoda). The chatbot can answer questions about hotel policies and provide room recommendations filtered by location, price, number of guests, and date.",
    url: "github.com/CUknot/NLP_Project.git",
    github: "github.com/CUknot/NLP_Project.git",
  },
];
...
export let interests = [
  ...
  },
  {
    ...
    details: "Experimenting with LLMs, vector databases, and data pipelines."
  },
  {
